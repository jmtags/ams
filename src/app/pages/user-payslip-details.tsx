...
export function UserPayslipDetailsPage() {
  const { id } = useParams();
    ...
    <UserLayout>
      <div className="space-y-6">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-semibold mb-1">My Payslip</h1>
            <p className="text-neutral-600">
              Review your payroll computation breakdown and download your payslip.
            </p>
          </div>

          <div className="flex gap-2 flex-wrap">
            <Button variant="outline" onClick={() => navigate("/my-payroll")}>
            ...
            <Button variant="outline" onClick={handlePrint} disabled={!record}>
          ...
          >
            ...
            <Card className="print:shadow-none print:border">
              <CardHeader>
                ...
                <CardDescription>
                  Your totals for this payroll record.
                </CardDescription>
              </CardHeader>
